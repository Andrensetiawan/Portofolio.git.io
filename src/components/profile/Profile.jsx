            ...
            <div className="px-6">
                ...
                <div className="w-full lg:w-3/12 px-4 lg:order-2 flex justify-center ">
                  <div className="relative pt-7 ">                  
                    <img
                       src={USER}
                       alt="Profile"
                       className="rounded-full h-64 w-64 object-cover border-4 border-white"/>                  
                  </div>
                </div>
              ...
              <div className="text-center mt-12">
                ...
                <div className="mb-2 text-blueGray-600 mt-10">
                  <i className="fas fa-briefcase mr-2 text-lg text-blueGray-400"></i>FrontEnd Defelopment
                </div>
                <div className="mb-2 text-blueGray-600">
                  <i className="fas fa-university mr-2 text-lg text-blueGray-400"></i>Hardwere and Sofwere Maintenance Komputer
                </div>
              </div>
              <div className="mt-10 py-10 border-t border-blueGray-200 text-center">
                <div className="flex flex-wrap justify-center">
                  <div className="w-full lg:w-9/12 px-4">
                    ...
                    <a href="#pablo" className="font-normal text-blue-600">Show more</a>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="flex flex-wrap items-center md:justify-between justify-center">
              <div className="w-full md:w-6/12 px-4 mx-auto text-center">
                <div className="text-sm text-blueGray-500 font-semibold py-1">
                  Made with 
                  <a href="https://react.dev/" className="text-blueGray-500 hover:text-gray-800" target="_blank">
                    React JS
                  </a>
                   by 
                  <a className="text-blueGray-500 hover:text-blueGray-800" target="_blank">
                     Andre Nur Setiawan
                  </a>.
                </div>
              </div>
